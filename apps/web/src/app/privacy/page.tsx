    ...
    >
      ...
      <LegalSection title="3. Processing activities and legal bases">
        <LegalTable
          ...
          rows={[
            [
              "Account and waitlist identifiers, name, email or login/invitation identifier, organization, requested and assigned role, waitlist/application/invitation and membership status, display name, and pilot callsign",
              "Manage the account-access waitlist, authenticate you, review a tenant membership application, send invitations, maintain membership, authorize tenant and role access, and administer the service",
              ...
              "While a waitlist, account, or membership request is pending or active and afterwards only under the approved unsuccessful-waitlist/application, account-closure, legal-obligation, or legal-claims retention criteria",
            ],
            [
      ...
      <LegalSection title="4. Recipients and service providers">
        ...
        <ul className="list-disc space-y-3 pl-6">
          <li>
            <strong>Clerk, Inc.</strong> — account-access waitlist, account
            authentication, tenant invitations, organization membership and
            roles, sessions, and abuse protection. See the{" "}
            <a

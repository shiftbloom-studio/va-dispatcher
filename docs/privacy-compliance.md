...
| `simbrief_dispatches` | Flight, preparing dispatcher and generating pilot links, trusted dispatcher-name snapshot and remarks, SimBrief Pilot/static/request IDs, planning inputs, generated OFP, errors, timestamps |
...
- Before enabling SimBrief, add Navigraph/SimBrief to the processing records
  ...
  the returned OFP. Confirm the applicable terms,
